    ...
    <tr>
        ...
        <td>
            <div class="text-center">
                    <a href="{{route('employee.edit', ['employee' => $m->slug])}}" class="btn  btn-primary btn-sm" title="edit">
                        <i class="fas fa-edit"></i>
                     </a>
                    <a href="{{route('employee.show', ['employee' => $m->slug])}}" class="btn  btn-primary btn-sm" title="detail">
                        <i class="fa fa-eye"></i>
                </a>
                ...
                data-toggle="modal" data-target="#hapus_event_{{ $m->id }}">
                    <i class="fa fa-trash"></i>
                                                                        ...
                                                                        {{-- End Modal edit --}}
            <!-- modal Delete -->
            <form method="POST" action="{{route('employee.destroy', ['employee' => $m->id])}}">
