            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <h2 class="header-title mt-2"><i class="fas fa-user-plus mr-1"></i>@yield('title')</h2>
                                        </div><!-- end col-->
                                        <div class="col-lg-4">
                        ...
                        <form action="{{route('employee.store')}}" class="parsley-examples" novalidate="" method="POST">
                            @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card-box">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Full name" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror">
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter email" class="form-control @error('email') is-invalid @enderror" value="{{old('email')}}">
                                            @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Phone Number" class="form-control @error('mobile_phone_number') is-invalid @enderror" value="{{old('mobile_phone_number')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter position" class="form-control @error('position') is-invalid @enderror" value="{{old('position')}}">
                                            @error('position')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('jobdesk') is-invalid @enderror" required="" name="jobdesk" placeholder="Enter JobDesk Employee"  rows="2" autocomplete="on">{{old('facilities_infrastructure')}}</textarea>
                                            @error('jobdesk')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter place of date" class="form-control @error('place_of_date') is-invalid @enderror" value="{{old('place_of_date')}}">
                                            @error('place_of_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter date of birth" class="form-control @error('date_of_birth') is-invalid @enderror" value="{{old('date_of_birth')}}">
                                            @error('date_of_birth')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
