                    ...
                    <!-- end page title -->
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"> {{$feedbackAll}} </span></h3>
                        ...
                        <div class="col-xl-12 " >
                                <div class="card-box">
                                    ...
                                    <h4 class="header-title mb-3 text-dark">Latest Member Data</h4>
